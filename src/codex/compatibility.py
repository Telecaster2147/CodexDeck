...
COMPATIBILITY_HANDLERS = (
    ...
    CompatibilityHandler(
        "tui_session_log.compaction",
        "typed TUI session log",
        "compact_session_log.jsonl",
        "unversioned-fixture-2026-07-24",
        "supporting compaction evidence",
        False,
        "Remove after the upstream typed log contract is retired and fixtures are migrated.",
    ),
    CompatibilityHandler(
        "hook.compaction",
        "optional private hook file",
        "compact_hooks.jsonl",
        "unversioned-fixture-2026-07-24",
        "supporting compaction evidence",
        False,
        "Remove when hook ingestion is removed by an explicit product decision.",
    ),
    CompatibilityHandler(
